    ...
    getKurentoClient(function (error, kurentoClient) {
        ...
        kurentoClient.create('MediaPipeline', function (error, pipeline) {
            ...
            createMediaElements(pipeline, ws, function (error, elements) {
                ...
                connectMediaElements(webRtcEndpoint, webRtcEndpoint, function (error) {
                    if (error) {
                        pipeline.release();
                        return callback(error);
                    }
...
function createMediaElements(pipeline, ws, callback) {
    let elements = [{
            ...
            params: {
                uri: "file:///tmp/HelloWorldRecorded.webm",
                mediaProfile: "WEBM"
            }
        },
        {
...
function connectMediaElements(client, endPoint, callback) {
